...
const GIT_HOMEPAGE: &str = "https://github.com/cita-cloud/kms_eth";
...
use crate::crypto::{check_transactions, ADDR_BYTES_LEN, SECP256K1_SIGNATURE_BYTES_LEN};
use crate::kms::Kms;
...
impl KmsService for KmsServer {
    async fn get_crypto_info(
        ...
        Ok(Response::new(GetCryptoInfoResponse {
            ...
            signature_len: crypto::SECP256K1_SIGNATURE_BYTES_LEN as u32,
        ...
        kms.sign_message(key_id, &msg).map_or_else(
            |status| {
                Ok(Response::new(SignMessageResponse {
                    ...
                    signature: [0; SECP256K1_SIGNATURE_BYTES_LEN].to_vec(),
                }))
            },
            |signature| {
                Ok(Response::new(SignMessageResponse {
